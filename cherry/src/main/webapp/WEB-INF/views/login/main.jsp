...
<link href=<c:url value="/resources/css/friend.css"/> rel="stylesheet">
<link rel="stylesheet"
...
@font-face{
font-family: 'Jeju Hallasan';url(http://fonts.googleapis.com/earlyaccess/jejuhallasan.css);
}
...
body {
	background-image: url(resources/images/tab1.jpg);
	width: 100%;
	height: 100%;
	overflow-x: hidden;
	overflow-y: auto;
...
setInterval(function(){
		    ...
		    var obj_chat = document.getElementById("no_chat_message"); 
		    var obj_req = document.getElementById("no_req_message");
		    var obj_brk = document.getElementById("no_brk_message"); 
 		    
		    if(obj_chat == null ||obj_req == null || obj_brk == null){
					$('#message_icon').before(
						'<span id="new_message" class="badge">New</span>'	
					);
		    }else{
				$('#new_message').remove();
			} 
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<div class="row">
		<div class="col-sm-12" data-spy="scroll" data-offset="50">
			<div class="container-fluid"
				style="background-color: #FFD3FF; background-image: url(resources/images/1.gif); background-size: 100% 200px; width: 60%; height: 200px;">
				<div style="position: absolute; right: 1%;">
					<br/>
					<i
						class="fa fa-commenting" aria-hidden="true"
						style="padding-right: 50px;" id="message_icon"> <span data-toggle="modal"
						data-target="#messageModal"
						style="cursor: pointer; font-size: 15px;">메세지</span>
					</i> <br /> <br /> <span style="padding-right: 50px; font-size: 15px">with_${loginUser.yname}</span>
					<br /> <br /> <a href="#boardSender" data-toggle="modal"
						style="color: navy;" onclick="gogo();"> 불만 접수</a> <br /> <br /> <a
						href='http://192.168.56.115:8890/cherry/logout'
						style="color: navy;">로그아웃</a>
				</div>
				<div align="center">
					<h2 class="yaman">Yaman</h2>
	...
	<div class="row">
		<div class="col-sm-6" data-spy="scroll" data-target=".navbar"
			data-offset="50">
			<nav class="navbar navbar-inverse" data-spy="affix"
				data-offset-top="197" style="background-color: #D2691E;">
				<div class="container-fluid">
			...
			<div id="tabs" class="tab-content">
				<div id="menu1" class="tab-pane fade in active">
					<div id="friend_list" class="tab-pane fade in active">
						...
						<!-- 친구 검색 기능 -->
						<div>
							<input type="search" class="form-control" style="border: 1px solid gray; width: 50%; margin-left: auto; margin-right: auto;"
								placeholder="검색할 이름을 입력하세요." name="searchName" id="searchName" />
						</div>
						<div style="overflow-x: hidden; overflow-y: auto; height: 670px">
							<br/> 	
							<div id="keyupFdInfo"></div>
							<table class="table">
								<thead class="fd_myInfoThead">
									<tr>
										<th>사진</th>
										<th>이름</th>
										<th>상태 메세지</th>
									</tr>
									<tr class="myInfo" style="background-color: orange;">
										<td><c:choose>
												<c:when test="${myInfo.yface == '없음'}">
                                          		사진이 없습니다.
                                       		</c:when>
												<c:otherwise>
													<img src="resources/images/${myInfo.yface}" style="width: 30px; height: 30px;" class="img-circle person">
												</c:otherwise>
											</c:choose></td>
										<td>${myInfo.yname }</td>
										<td>${myInfo.yhello }</td>
										<td style="display: none"><span class="myId">${myInfo.yaman_id}</span>
											<span class="myFace">${myInfo.yface }</span> <span
											class="myName">${myInfo.yname }</span> <span class="mySchool">${myInfo.yschool }</span>
											<span class="myCompany">${myInfo.ycompany }</span> <span
											class="myPhone">${myInfo.yphone }</span> <span
											class="myEmail">${myInfo.yemail }</span> <span
											class="myHello">${myInfo.yhello }</span></td>
									</tr>
								</thead>
								<tbody id="friendInfo">
									<c:forEach var="myFriendList" items="${myFriendList}">
										<c:choose>
											<c:when test="${myFriendList.yok == 1 }">
												<tr id="${myFriendList.yaman_two}"
													style="background-color: skyblue;"
													onclick="detail('${myFriendList.yface}','${myFriendList.yname}','${myFriendList.yschool}','${myFriendList.ycompany}','${myFriendList.yphone}','${myFriendList.yemail}','${myFriendList.yhello }','${myFriendList.yok }','${myFriendList.yaman_id}');">
													<td><c:choose>
															<c:when test="${myFriendList.yface == '없음'}">
                                               				사진이 없습니다.
                                           					</c:when>
															<c:otherwise>
																<img src="resources/images/${myFriendList.yface}"
																	style="width: 30px; height: 30px;" class="img-circle person">
															</c:otherwise>
														</c:choose></td>
				...
				<div id="menu2" class="tab-pane fade">
					<div style="text-align: center;">
						...
						<div
							style="text-align: center; overflow-x: hidden; overflow-y: auto; height: 670px">
							<table id="myChatRoomList"
								class="table table-hover table-bordered">
								<tr class="danger">
									<th style="text-align: center;">채팅방 이름</th>
									<th style="text-align: center;">참여자</th>
									<th style="text-align: center;">삭제</th>
								</tr>
								<c:forEach var="myChatRoomList" items="${myChatRoomList}">
									<tr class="${myChatRoomList.ychatlist_id} warning"
										style="cursor: pointer;">
										<td onClick="RoomListOpenWin('${myChatRoomList.roomname}');">
											${myChatRoomList.roomname}</td>
										<td>${myChatRoomList.yname }</td>
										<td>
											<button type="button" class="btn btn-default btn-lg"
												onClick="deleteroom(${myChatRoomList.ychatlist_id});">
				...
				<div id="menu3" class="tab-pane fade">
					<div style="overflow-x: hidden; overflow-y: auto; height: 670px">
						<div class="container" style="padding-top: 20px;">
							<div>
								<input type="text" class="form-control" id="searchYname"
									value="" placeholder="이름"
									style="width: 52%; margin-bottom: 20px;">
							</div>
							<div>
								<input type="text" class="form-control" id="searchYschool"
									value="" placeholder="학교명"
									style="width: 52%; margin-bottom: 20px;">
							</div>
							<div>
								<input type="text" class="form-control" id="searchYphone"
									value="" placeholder="전화번호"
									style="width: 52%; margin-bottom: 20px;">
							</div>
							<div>
								<input type="text" class="form-control" id="searchYemail"
		...
		<div class="col-sm-6">
			<nav class="navbar navbar-inverse" data-offset-top="197"
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="myNavbar2">
						<ul class="nav nav-tabs">
							<li><a data-toggle="tab" href="#schedule">약속</a></li>
							<li><a data-toggle="tab" href="#promise" onClick="earlyPromise();">빠른일정</a></li>
			...
			<div class="tab-content">
				...
				<div id="promise" class="tab-pane fade" style="overflow-x: hidden; overflow-y: auto; height: 670px">
					<!-- 메인 리스트 -->
					<table class="table table-striped" id="fastPromise">
						<colgroup>
							<col width="60">
							<col>
							<col width="115">
					...
					<h4>
						<a href="./excelDownload" style="color: navy;"
							class="btn btn-block btn-default">약속리스트 Excel 다운로드</a>
					</h4>
												...
												<div class="row" >
													<div id="myCarousel" class="carousel slide" data-ride="carousel">
														<div class="carousel-inner" role="listbox" id="carousel-inner" >
															...
															<a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev" style="height:25em;">
															      	<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
															      	<span class="sr-only">Previous</span>
															</a>
															<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next" style="height:25em;">
							...
							<div class="row">
								...
								<div class="col-sm-6 pull-right" style="margin-top: 50px;">
									<table class="fd_myFdInfo">
										...
										<tr>
											<td><input type="hidden" readonly="readonly" value=""
												id="ok"></td>
										</tr>
										<tr>
											<td><input type="hidden" readonly="readonly" value=""
									...
									<br>
									<div class="fd_myFdInfoBtn">
										<button type="button" class="btn btn-success"
											data-dismiss="modal" id="chat_btn">채팅</button>
										<button type="button" class="btn btn-success"
											data-dismiss="modal" id="breakFriend">절교하기</button>
										<button type="button" class="btn btn-success"
			...
			<div class="modal fade" id="breakFriendModal" role="dialog">
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						...
						<div class="modal-body">
							<input type="text" id="brkFd" value="" class="form-control"
								placeholder="절교 메세지를 입력하세요">
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default"
								data-dismiss="modal" id="byeFd">잘가</button>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-sm-6 pull-left">
									...
									<c:choose>
										...
										<c:otherwise>
											<img src="resources/images/${myInfo.yface}"
												style="width: 15em; height: 15em;" >
										</c:otherwise>
									</c:choose>
								</div>
								<div class="col-sm-6 pull-right" style="margin-top: 50px;">
									<table class="fd_myInfo">
										<tr>
											<th>이름</th>
											<td><input type="text" readonly="readonly" value=""
												id="myName"></td>
									...
									<br>
									<div class="fd_myInfoBtn">
										<button type="button" class="btn btn-success"
											data-dismiss="modal" id="myInfoUpdate">내정보수정</button>
										<button type="button" class="btn btn-success"
											data-dismiss="modal">닫기</button>
									</div>
								</div>
					...
					<div class="modal-content">
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-6 pull-left">
									<h3 class="fd_a">수정</h3>
									<form id="myPhotoFrm" name="myPhotoFrm"
										enctype="multipart/form-data">
										<input type="file" id="UpdateFace" value=""
											name="updateMyFace">
									</form>
								</div>
								<div class="col-sm-6 pull-right" style="margin-top: 50px;">
									<table class="fd_myInfoUpdate">
										<tr>
											<th>이름</th>
									...
									<div style="text-align: left;">
										<button type="button" class="btn btn-success"
											data-dismiss="modal" id="updateYaman">수정</button>
										<button type="button" class="btn btn-success"
											data-dismiss="modal">닫기</button>
									</div>
								</div>
		...
		<div id="chat-room" title="채팅방 제목">
			<fieldset>
				...
				<input type="text" id="room-name" value='' class="form-control"
					placeholder="채팅방 이름을 입력하세요">
				<button id="check-room-name" class="btn btn-default"
					style="float: right;">방 이름 검색</button>
			</fieldset>
			<input type="text" id="room-okay" value=''
									...
									<div class="container-fluid">
										<div class="navbar-header">
											<button type="button" class="navbar-toggle"
												data-toggle="collapse" data-target="#messageModalMenu">
                                   ...
                                   <div id="addPromise" class="collapse">
                                             <div class="row">
                                                <div class="col-sm-6">
                                                   ...
                                                   <div class="form-group">
                                                      <label for="yprodate1">약속 날짜 :  </label><input type="text" class="form-control" id="yprodate1" readonly>
                                                   </div>
                                                   <div class="form-group">
                                                      <label for="yprostart">약속 시작시간 :  </label><input type="time" class="form-control" id="yprostart">
                                                   </div>
                                                   <div class="form-group">
                                      ...
                                      <button type="submit" class="btn btn-primary" data-dismiss="modal" id="addPromise1">submit</button>
                       ...
                       <div class="modal-body">
                         ...
                         <form action="./write"  method = "post">
                                  <div class="row">
                                    <div class="col-sm-6">
                                       <!-- <div class="form-group">
                                          <label for="ypromise_id2">약속 번호 :  </label> --><input type="hidden" class="form-control" id="ypromise_id2" name="ypromise_id2" value="${ypromise_id}">
                                       <!-- </div> -->
                                       <div class="form-group">
                                       ...
                                       <div class="form-group">
                                          <label for="yprostart2">약속 시작시간 :  </label><input type="time" class="form-control" id="yprostart2" name="yprostart2" value="${yprostart}" onblur="getPromise2(this.value)">
                                       </div>
                                       <div class="form-group">
						...
						<div class="modal-body">
							...
							<form action="./write" method="get">
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label for="ypromise_id2">약속 번호 : </label><input type="text"
												class="form-control" id="ypromise_id2" name="ypromise_id2"
												value="${ypromise_id}">
										</div>
										<div class="form-group">
											<label for="yproname2">약속 이름 : </label><input type="text"
												class="form-control" id="yproname2" name="yproname2"
												value="${yproname}">
										</div>
										<div class="form-group">
											<label for="yprodate2">약속 날짜 : </label><input type="text"
												class="form-control" id="yprodate2" name="yprodate2"
												value="${yprodate}">
										</div>
										<div class="form-group">
											<label for="yprostart2">약속 시작시간 : </label><input type="time"
												class="form-control" id="yprostart2" name="yprostart2"
												value="${yprostart}" onblur="getPromise2(this.value)">
										</div>
										<div class="form-group">
											<label for="yproend2">약속 종료시간 : </label><input type="time"
												class="form-control" id="yproend2" name="yproend2"
												value="${yproend}">
										</div>
										<div class="form-group">
											<label for="yproloc2">약속 장소 : </label><input type="text"
												class="form-control" id="yproloc2" name="yproloc2"
												value="${yproend}">
										</div>
									</div>
								</div>
								<button type="submit" class="btn btn-primary"
									data-dismiss="modal" id="submit1">submit</button>
							</form>
		...
		<div class="modal-dialog modal-sm" style="width: 600px;">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title" style="color: maroon;">불만 신고</h4>
				</div>
				<div class="modal-body">
						<div class="" align="center"
							style="padding-top: 5%;">
							<h1>불편사항을 적어주세요</h1>
							<div  align="center" style="width: 500px;height:500px;font-size: 30px; box-shadow: 0px 0px 15px #cecece; border:1px solid #e0e0e0;">
								<div style="box-shadow: 0px 0px 15px #cecece; border:1px solid #e0e0e0;" >
									<p style="display: inline;"align="left">제목:</p><input type="text" id="ysubject" name="ysubject"
								...
								<textarea rows="10"
											...
											id="ycontent" name="ycontent"></textarea>
								</div>
						...
						<div align="right" style="padding-right: 5%;padding-top: 50px;">
							<input class="board" type="button" id="send" name="send" onclick="send();"
								style="display: none;" value="보내기"/>
							<input class="board" type="button" id="sendOk" name="sendOk"
								onClick="sure_content();" value="완료"/>

						</div>
						<input type="hidden" id="yaman_id" name="yaman_id" value="${logindto.yaman_id}">
				</div>
				<div class="modal-footer">
					<div style="text-align: center;">Copyright © Yaman Corp</div>
				</div>
			</div>
		</div>
	</div>
